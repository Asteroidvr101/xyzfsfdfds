...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "3E875" # Playfab Title Id
        self.SecretKey: str = "N5NTKHXEBMQ736KJASQ4PUEMW5CEIROOKF9Y9CKPHRP7B3M9I9" # Playfab Secret Key
        self.ApiKey: str = "OC|24001018819494595|95af1af47963472bdd0cb116dac1505c" # App Api Key
